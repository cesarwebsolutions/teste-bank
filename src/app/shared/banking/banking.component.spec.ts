...
describe('BankingComponent', () => {
  ...
  it(`(U) setDepositar(): shoud transfer carteira from poupanca`, ()=>{
   ...
   it(`(U) setdeDositar(): shoud transfer carteira dont have string (isNaN)
    or carteira < value
   `, () => {
     expect(component.setdeDositar('string')).not.toBeTruthy();
     expect(component.setdeDositar('100')).not.toBeTruthy();
